...
```typescript
import { createLogger } from '@daytona/logger';
```
...
```typescript
import { createLogger, createTransport } from '@daytona/logger';
import { createConsole } from '@daytona/logger/transports/console';
